	...
	public function run(): void
	{
		...
		$templates = [
			...
			[
				...
				'subject' => 'Referral Bonus Awarded on {app_name}',
				'content' => 'Hi {upliner_name},
                                      You have have been awarded a {referral_type} bonus of {bonus} from your downliner {downliner_name}. Login to your portal to show details.
                                      {url}',
				'status'  => true,
			],
			[
