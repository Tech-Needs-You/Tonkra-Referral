        ...
        <div class="card-content">
          <div class="card-body">
            {{-- <div class="col-md-6 col-12"> --}}
              <div class="form-body">
                <form class="row form form-vertical" action="{{ route('referral.admin.setting.store') }}" method="post">
                  @csrf
                  <div class="col-md-12">


                    <div class="row">
                      <label for="" class="text-uppercase mb-1 text-sm text-muted">{{ __('referral::locale.labels.referral_settings') }}</label>
                     
                      <div class="col-md-6 col-12 mb-1">
                        <label for="status" class="form-label required">{{ __('referral::locale.labels.status') }}</label>
                        <select class="form-select" id="status" name="status">
                          <option value="1" @if ((bool) config('referral.status')) selected @endif>
                            {{ (bool) config('referral.status') ? __('referral::locale.labels.enabled') :
                            __('referral::locale.labels.enable') }}
                          </option>
                          <option value="0" @if ((bool) !config('referral.status')) selected @endif>
                            {{ (bool) !config('referral.status') ? __('referral::locale.labels.disabled') :
                            __('referral::locale.labels.disable') }}
                          </option>
                        </select>
                        @error('status')
                      ...
                      <div class="col-md-6 col-12 mb-1">
                        <label for="bonus" class="form-label required">{{ __('referral::locale.referrals.bonus') }}
                          (%)</label>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-12 mb-1">
                        <label for="email_notification" class="form-label required">{{
                        ...
                        <select class="form-select" id="email_notification" name="email_notification">
                          <option value="1" @if ((bool) config('referral.email_notification')) selected @endif>
                            {{ (bool) config('referral.email_notification') ? __('referral::locale.labels.enabled') :
                            __('referral::locale.labels.enable') }}
                          </option>
                          <option value="0" @if ((bool) !config('referral.email_notification')) selected @endif>
                            {{ (bool) !config('referral.email_notification') ? __('referral::locale.labels.disabled') :
                            __('referral::locale.labels.disable') }}
                          </option>
                        </select>
                      ...
                      <div class="col-md-6 col-12 mb-1">
                        <label for="sms_notification" class="form-label required">{{
                        ...
                        <select class="form-select" id="sms_notification" name="sms_notification">
                          <option value="1" @if ((bool) config('referral.sms_notification')) selected @endif>
                            {{ (bool) config('referral.sms_notification') ? __('referral::locale.labels.enabled') :
                            __('referral::locale.labels.enable') }}
                          </option>
                          <option value="0" @if ((bool) !config('referral.email_notification')) selected @endif>
                            {{ (bool) !config('referral.email_notification') ? __('referral::locale.labels.disabled') :
                    ...
                    <div class="col-12">
                      <div class="mb-1">
                        <label for="default_senderid" class="form-label required">{{
                          __('referral::locale.referrals.default_senderid')
                          }}</label>
                        <input type="text" id="default_senderid" name="default_senderid" class="form-control"
                    ...
                    <div class="row mt-2">
                      <label for="" class="text-uppercase mb-1 text-sm text-muted">{{ __('referral::locale.referral_bonuses.referral_bonus_settings') }}</label>
                      <div class="col-md-6 col-12 mb-1">
                        <label for="redemption_rate" class="form-label required">{{ __('referral::locale.referral_bonuses.redemption_rate') }}</label>
                        <input type="number" step="0.001"min="0.001" class="form-control" id="redemption_rate" name="redemption_rate" value="{{ config('referral.redeem.rate') }}">
                      ...
                      <div class="col-md-6 col-12 mb-1">
                        <label for="min_redemption_amount" class="form-label required">{{ __('referral::locale.referral_bonuses.minimum_redemption_amount') }}</label>
                        <input type="number" step="1" min="1" value="{{ config('referral.redeem.min_amount') }}" class="form-control" id="min_redemption_amount" name="min_redemption_amount">
                        @error('min_redemption_amount')
                          <p><small class="text-danger">{{ $message }}</small></p>
                        @enderror
                      </div>
                    </div>
                    ...
                    <div class="form-group col-12">
                      <label for="guideline" class="form-label text-dark required">GuideLines</label>
                      <textarea name="guideline" id="guideline"
                        class="form-control">{{ old('guideline', Helper::desanitizeFromEnv(config('referral.guidelines')))}}</textarea>
                    </div>
